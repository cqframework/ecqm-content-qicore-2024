...
SET "dlurl=https://oss.sonatype.org/service/local/artifact/maven/redirect?r=releases&g=org.opencds.cqf&a=tooling-cli&v=2.5.0"
SET tooling_jar=tooling-cli-2.5.0.jar

...
SET "dlurl=https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=org.opencds.cqf&a=tooling-cli&v=3.0.0"
SET tooling_jar=tooling-3.0.0.jar
